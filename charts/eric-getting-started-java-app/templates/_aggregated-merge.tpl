...
*/ -}}
{{- define "eric-getting-started-java-app.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-getting-started-java-app.mergeAnnotations" -}}
  {{- include "eric-getting-started-java-app.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-getting-started-java-app.mergeLabels" -}}
  {{- include "eric-getting-started-java-app.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
